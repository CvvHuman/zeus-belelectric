        ...
        {/* Кнопки */}
          ...
          >
            <button
              ...
              className="inline-flex items-center gap-3 bg-yellow-500 hover:bg-yellow-400 text-slate-950 font-bold text-lg py-4 px-8 rounded-xl shadow-[0_0_30px_rgba(234,179,8,0.3)] hover:shadow-[0_0_50px_rgba(234,179,8,0.5)] transition-all duration-200 hover:-translate-y-1 active:translate-y-0"
            >
              <FaPhone className="text-slate-950" />
              {t('callbackButton')}
            </button>
          </motion.div>
        </div>
